        ...
        <form action="/activeAir/{{$id}}" method="POST" class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8 col-sm-offset-2">
                    <span>Día</span><input type="text" name="day" id="building-name" class="form-control">
                    <span>Hora de encendido</span><input type="text" name="switched_on_hour" id="building-name" class="form-control">
                    <span>Hora de apagado</span><input type="text" name="switched_off_hour" id="building-name" class="form-control">
                </div>
            </div>
